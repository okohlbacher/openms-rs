...
| Feature finding (picked) | [FeatureFinderAlgorithmPicked helper structures](docs/FEATURE_FINDER_PICKED_HELPER_STRUCTS_SUPPORT.md): seeds, mass traces, intensity profiles and isotope patterns, the first step of the FeatureFinderCentroided chain; [the FeatureFinderAlgorithmPicked front half](docs/FEATURE_FINDER_PICKED_SUPPORT.md): parameters, input checks, intensity, trace and isotope-pattern scores, pattern precalculation and seed selection |
