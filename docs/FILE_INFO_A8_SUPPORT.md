...
Tests: `tests/file_info_a8.rs` (18), and three older files that change with the
...
Oracle: `../oracle/a8-fileinfo`, the A7 machinery, **68** cases of the Release
...
`OpenMS::FileInfo::run` against the same install; all 82 run twice and
reproduced. **60** reports are compared byte for byte, text and TSV, with only
...
at `bc9cc12` (`src/tests/class_tests/openms/data/`) and 19 generated by
...
| --- | --- | --- | --- | --- |
| mzXML | 20 | 2 | 20 (+ `x4_bare` on stdout) | — |
| mzData | 18 | 1 | 16 | 3 (section 4.1) |
| MGF | 21 | 1 | 17 | 1 (section 4.2) |
