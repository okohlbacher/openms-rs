...
reaches every tool body, size-derived mzML reader ceilings with the source's
timestamp leniency, per-record writer budgets with `indexedmzML` by default, the
